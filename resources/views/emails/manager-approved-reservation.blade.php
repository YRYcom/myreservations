...
<head>
    ...
    <title>{{ __('filament.emails.manager_approved_reservation.subject') }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ __('filament.emails.manager_approved_reservation.title') }}</h1>
    </div>
    ...
    <div class="content">
        <p>{{ __('filament.emails.manager_approved_reservation.greeting') }}</p>

        <div class="info-box">
            <strong>{{ __('filament.emails.manager_approved_reservation.message') }}</strong>
        </div>
        ...
        <div class="reservation-details">
            ...
            <div class="detail-row">
                <span class="detail-label">{{ __('filament.resources.reservations.fields.user_id') }} :</span>
