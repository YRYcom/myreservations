...
<head>
    ...
    <title>{{ __('filament.emails.reservation_pending_manager.subject') }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ __('filament.emails.reservation_pending_manager.title') }}</h1>
    </div>
    
    <div class="content">
        <p>{{ __('filament.emails.reservation_pending_manager.greeting') }}</p>
        
        <div class="alert">
            <strong>{{ __('filament.emails.reservation_pending_manager.alert') }}</strong>
        </div>
