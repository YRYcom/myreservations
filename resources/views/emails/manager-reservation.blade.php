...
<head>
    ...
    <title>{{ __('filament.emails.manager_reservation.subject') }}</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>{{ __('filament.emails.manager_reservation.title') }}</h1>
    </div>
    
    <div class="content">
        <p>{{ __('filament.emails.manager_reservation.greeting') }}</p>
        
        <div class="info-box">
            <strong>{{ __('filament.emails.manager_reservation.message') }}</strong>
        </div>
        ...
        <div class="reservation-details">
            ...
            <div class="detail-row">
                <span class="detail-label">{{ __('filament.emails.manager_reservation.created_by') }} :</span>
        ...
        <p>{{ __('filament.emails.manager_reservation.info') }}</p>
        ...
        <div style="text-align: center; margin: 30px 0;">
            <a href="{{ config('app.url') }}/home/reservations/{{ $reservation->id }}/edit" 
               style="display: inline-block; padding: 12px 24px; background-color: #10b981; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">
                {{ __('filament.emails.reservation_reminder_manager.button') }}
            </a>
        </div>
    </div>
