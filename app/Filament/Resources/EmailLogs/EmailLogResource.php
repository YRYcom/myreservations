...
class EmailLogResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Logs d\'emails';
    
    protected static ?string $modelLabel = 'Log d\'email';
    
    protected static ?string $pluralModelLabel = 'Logs d\'emails';
